package com.orderTrackerIndicator.custom.stateprogressbar;
...
import com.orderTrackerIndicator.custom.stateprogressbar.components.StateItemDescription;
import com.orderTrackerIndicator.custom.stateprogressbar.components.StateItemNumber;
import com.orderTrackerIndicator.custom.stateprogressbar.listeners.OnStateItemClickListener;
import com.orderTrackerIndicator.custom.stateprogressbar.utils.FontManager;
...
public class StateProgressBar extends View {
    ...
    public enum StateNumber {
        ONE(1), TWO(2), THREE(3), FOUR(4), FIVE(5), SIX(6),SEVEN(7),Hundred(100);
        private int value;
